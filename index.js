...
(function () {
  ...
  function createFloatingBall() {
    ...
    makeDraggable(ball, "mood-manager-ball-position", {
  ...
  function createStatusPanel() {
    ...
    makeDraggable(panel, "mood-manager-panel-position", {
  ...
  function createSettingsUI() {
                ...
                <div class="inline-drawer">
                    ...
                    <div class="inline-drawer-content">
                        <div class="example-extension_block flex-container">
                            ...
                            <input type="text" id="mood-api-url" class="text_pole" value="${
                              settings.apiUrl
                            }" />
                        </div>
                        <div class="example-extension_block flex-container">
                            <label for="mood-api-key">API Key:</label>
                            <input type="text" id="mood-api-key" class="text_pole" value="${
                              settings.apiKey
                            }" />
                        </div>
                        <div class="example-extension_block flex-container">
                            <input type="checkbox" id="mood-enabled" ${
    ...
    // Bind events
    $("#mood-api-url").on("input", function () {
      settings.apiUrl = $(this).val();
      saveSettings();
    });
    $("#mood-api-key").on("input", function () {
      settings.apiKey = $(this).val();
      saveSettings();
    });
    $("#mood-enabled").on("change", function () {
  ...
  function makeDraggable(element, storageKey, initialPos) {
    ...
    document.addEventListener("mouseup", () => {
      ...
      localStorage.setItem(
        storageKey,
        JSON.stringify({ x: element.offsetLeft, y: element.offsetTop })
      );
    });
  ...
  function initPlugin() {
    ...
    SillyTavern.eventSource.on(
      SillyTavern.eventTypes.MESSAGE_UPDATED,
      onMessageUpdate
    );
